    ...
    return (
        <nav className='navbar'>
            <div className='small-nav-items sm:nav-items'>
                ...
                <Link className='cursor-pointer' to='skills' smooth={true} offset={-75} duration={500} >Skills</Link>
                <Link className='cursor-pointer' to='experience' smooth={true} offset={-90} duration={500} >Experience</Link>
